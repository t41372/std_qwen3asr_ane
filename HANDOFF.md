...
- **品質**：8-bit 版在 200 句挑選集和 200 句驗證集上，錯誤率和未壓縮版、和官方 PyTorch 版都量不出差別。門檻是事先寫在 [research/preregistration-2026-09-13.md](research/preregistration-2026-09-13.md) 的：英文詞錯誤率最多差 +0.25 個百分點、中文字錯誤率最多差 +0.40 個百分點。實測差 0.00 和 −0.03。
