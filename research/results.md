...
後續進度見 [results-2026-09-13.md](results-2026-09-13.md)；2026-09-12 當時的狀態：穩定 compiled 路徑的重複載入約1.5秒、180秒串流診斷通過，且取得SMC整機能耗對照（目前ANE基準每項有用工作的能耗高於MLX）。下文保留首版的測量範圍；原始速度、能耗及廣泛品質目標仍未完成。
